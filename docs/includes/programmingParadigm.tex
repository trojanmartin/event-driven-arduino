...
\noindent \par Programovacia paradigma je spôsob riešenia programátorských problémov \cite{Samuel2018AnII}. Poznáme veľké množstvo programovacích paradigiem. Medzi ne patria aj nasledujúce štyri:
\begin{itemize}
...
\noindent \par Základnou myšlienkou je príkaz, ktorý má merateľný dopad na aktuálny stav 
...
\noindent \par Funkcionálna paradigma je postavená na koncepte matematických funkcií, ktoré používajú podmienené 
...
\noindent \par Paradigma, ktorej myšlienka je inšpirovaná svetom okolo nás. Čokoľvek môže 
